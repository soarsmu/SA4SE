...
print('Running model {} in App reviews'.format(m_name))

#### Read data
train_data=pd.read_pickle(data_folder/'app-train.pkl')
train_data['label']=train_data['label'].replace(-1, 2)

X_train=train_data['sentence']
y_train=train_data['label']

test_data=pd.read_pickle(data_folder/'app-test.pkl')
test_data['label']=test_data['label'].replace(-1, 2)
...
if rerun_flag:
    ...
    to_save={'app_{}'.format(m_name): model}
    ...
    run_saved_model(prediction_dataloader, cur_model, 'app', m_name)