...
train_df=pd.read_pickle(api_train)
...
begin=time.time()
#test_df = pd.read_csv(api_test, usecols=['sentence','label'])
...
print("Accuracy of {} on API Reviews is: {}".format(m_name, accuracy_score(flat_true_labels,flat_predictions)))
