...
print('Running model {} in API reviews'.format(m_name))

#### Read data
train_data=pd.read_pickle(data_folder/'api-train.pkl')
train_data['label']=train_data['label'].replace(-1, 2)

X_train=train_data['sentence']
y_train=train_data['label']

test_data=pd.read_pickle(data_folder/'api-test.pkl')
...
if rerun_flag:
    ...
    run_saved_model(prediction_dataloader, cur_model, 'api', m_name)